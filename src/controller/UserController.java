...
public class UserController {
    ...
    public void createUsers(int id, String username, String email, String password, String contactDetails, String rol) throws SQLException {
        String createSQL = "INSERT INTO user(id, username, email, password, contactDetails, rol) VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public void updateUsers(String nameUser, String emailUser, String password, String contactDetails, int id) throws SQLException {
        String updateSQL = "UPDATE users SET nameUser = ?, emailUser = ?, password = ?, contactDetails = ? WHERE id = ?;";
    ...
    public void createUsers(String correo, String contrasenia) {
